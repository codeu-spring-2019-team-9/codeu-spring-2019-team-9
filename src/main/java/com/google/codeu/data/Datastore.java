...
public class Datastore {
   ...
   */
  public void storeUserFormData(Tea userChart, String username) {
    if (username != null) {
    Entity userFormData = new Entity("UserFormData", username);
  ...
  public void updateUserFormData(Tea userChart) {
